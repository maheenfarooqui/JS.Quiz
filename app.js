...
var questions = [
  {
    question : "Q1: What is the primary purpose of the const keyword in JavaScript?",
    ...
    {
    question : "Q2: Which array method adds a new element to the end of an array?",
    opt1: "pop()",
    opt2: "push()",
    opt3: "shift()",
    opt4: "unshift()",
    ...
    {
    question : "Q4: Which of the following is the correct syntax for an Arrow Function?",
    opt1: "function => {}",
    opt2: "arrow() -> {}",
    opt3: "() => {}",
    opt4: "() => return {}",
    ...
    {
    question : "Q7: Which ES6 feature is used to extract data from objects into distinct variables?",
                ...
                <div class="quiz-card mb-4" id="displayArea">
                    ...
                    <div class="options-group">
                        <label class="option-label">
                            <input type="radio" name="option" class="d-none" value="1">
                            <span>${questions[qIndex].opt1}</span>
                        </label>
                        <label class="option-label">
                            <input type="radio" name="option" class="d-none" value="2">
...
function submitQuize(){
  ...
  document.getElementById("resultScreen").innerHTML =`<div class="quiz-card">
                    ...
                    <h1 class="display-1 fw-bold text-primary mt-3" id="percValue">85%</h1>
                    <p class="lead fw-medium" id="scoreText">You scored 8 out of 10</p>
